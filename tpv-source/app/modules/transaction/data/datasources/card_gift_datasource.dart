...
import '../providers/card_gift_provider.dart';
import '../providers/gift_provider.dart';

/// Implementación de la interfaz de fuente de datos local: LocalDataSource
class LocalCardGiftDataSourceImpl implements LocalDataSource {
...
class RemoteCardGiftDataSourceImpl implements RemoteDataSource {
  final http.Client client = Get.find();

  RemoteCardGiftDataSourceImpl();

  @override
  CardGiftProvider get getProvider => Get.find();
  ...
  CardGiftModel getModelFromJson(String data) {
    return cardGiftModelFromJson(data);
  }
