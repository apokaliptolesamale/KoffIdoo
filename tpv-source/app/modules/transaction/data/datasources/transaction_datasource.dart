...
class LocalTransactionDataSourceImpl implements LocalDataSource {
  ...
  TransactionModel getModelFromJson(String data) {
    return transactionModelFromJson(data);
  }
  ...
  @override
  Future<TransactionModel> request(
...
class RemoteTransactionDataSourceImpl implements RemoteDataSource {
  final http.Client client = Get.find();
