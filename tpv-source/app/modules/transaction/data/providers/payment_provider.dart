...
class PaymentProvider extends GetProviderImpl {
  @override
  Future<Either<Exception, TModel>> addEntity<TModel>(TModel entity) async {
    log("Adicionando nueva entidad de tipo:PaymentModel.");
    Map<String, dynamic> data = {};
    if (entity is PaymentModel) {
      data = entity.toJson();
  ...
  Future<Either<Exception, TModel>> getEntity<TModel>(dynamic id) async {
    log("Cargando entidad de tipo 'Payment' con identificador=$id");
    String url = '';
    Map<String, String> headers = await HeaderRequestImpl(
      headers: {
        "Accept": "application/json",
  ...
  @override
  PaymentProvider setBaseUrl(String newBaseUrl) {
