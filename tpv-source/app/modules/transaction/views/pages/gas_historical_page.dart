...
import '/app/modules/transaction/views/gas_historical_view.dart';

class GasHistoricalPage<T> extends CustomAppPageImpl<T> {
  @override
  ...
  static GasHistoricalPage builder({
    String name = "/gasService/gasServiceHistorical",
    int index = -1,
    bool? popGesture,
  ...
  static GetPageBuilder getPageBuilder(String name, String keyMap) {
    Routes.getInstance.addRoute("GAS_HISTORICAL", name);
    return () => GasHistoricalView();
  }
}
