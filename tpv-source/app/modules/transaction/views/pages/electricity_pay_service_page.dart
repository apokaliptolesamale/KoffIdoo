...
import '/app/modules/transaction/views/electricity_pay_service_view.dart';

class ElectricityPayServicePage<T> extends CustomAppPageImpl<T> {
  @override
  ...
  static ElectricityPayServicePage builder({
    String name = "/electricityService/electricityPayService",
    int index = -1,
    bool? popGesture,
  ...
  static GetPageBuilder getPageBuilder(String name, String keyMap) {
    Routes.getInstance.addRoute("ELECTRICITY_PAY_SERVICE", name);
    return () => PayElectricityServiceFrame();
  }
}
