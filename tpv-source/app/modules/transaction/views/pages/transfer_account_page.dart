...
class TransferAccountPageImpl<T> extends CustomAppPageImpl<T> {
  @override
  ...
  static TransferAccountPageImpl builder({
    String name = "/transfer/transferAccountPage",
    int index = -1,
    bool? popGesture,
  ...
  static GetPageBuilder getPageBuilder(String name, String keyMap) {
    Routes.getInstance.addRoute("TRANSFER_ACCOUNT_PAGE", name);
    return () => TransferAccountView(
        /*param: '',*/
        );
  }
}
