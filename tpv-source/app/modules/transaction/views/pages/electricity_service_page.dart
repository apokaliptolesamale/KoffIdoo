...
import '/app/modules/transaction/views/electricity_service_view.dart';
import '/app/routes/app_pages.dart';

class ElectricityService<T> extends CustomAppPageImpl<T> {
  @override
  ...
  static ElectricityService builder({
    String name = "/electricityService",
    int index = -1,
    bool? popGesture,
  ...
  static GetPageBuilder getPageBuilder(String name, String keyMap) {
    Routes.getInstance.addRoute("ELECTRICITY", name);
    return () => ElectricityMainView();
  }
}
