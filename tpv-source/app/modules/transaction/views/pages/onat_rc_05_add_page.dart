...
class OnatRc05AddPage<T> extends CustomAppPageImpl<T> {
  @override
  ...
  static OnatRc05AddPage builder({
    String name = "/onatService/onatAddEmailRc05",
    int index = -1,
    bool? popGesture,
  ...
  static GetPageBuilder getPageBuilder(String name, String keyMap) {
    Routes.getInstance.addRoute("ONAT_ADD_RC_05 ", name);
