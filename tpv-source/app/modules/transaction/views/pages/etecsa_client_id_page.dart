...
import '../etecsa_client_id_view.dart';

class EtecsaServiceClientIdPage<T> extends CustomAppPageImpl<T> {
  @override
  ...
  static EtecsaServiceClientIdPage builder({
    String name = "/etecsaService/etecsaClientIdView",
    int index = -1,
    bool? popGesture,
    Map<String, String>? parameters,
    String keyMap = "ETECSA_CLIENT_ID_VIEW",
    String? title,
    Transition? transition,
