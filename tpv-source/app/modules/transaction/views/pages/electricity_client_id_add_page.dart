...
import '/app/modules/transaction/views/client_id_add_frame_view.dart';

class ElectricityServiceClientIdPage<T> extends CustomAppPageImpl<T> {
  @override
  ...
  ElectricityServiceClientIdPage({
    required this.page,
    required this.name,
    this.keyMap = "/",
    this.index = -1,
  ...
  static ElectricityServiceClientIdPage builder({
    String name = "/electricityAddClientId/electricityClientId",
    int index = -1,
    bool? popGesture,
  ...
  static GetPageBuilder getPageBuilder(String name, String keyMap) {
    Routes.getInstance.addRoute("ELECTRICITY_ADD_CLIENT_ID", name);
    return () => ClientIdAddFrame();
  }
}
