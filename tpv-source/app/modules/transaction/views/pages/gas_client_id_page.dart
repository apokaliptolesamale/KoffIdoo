...
import '../gas_client_id_view.dart';

class GasClientIdPage<T> extends CustomAppPageImpl<T> {
  @override
  ...
  static GasClientIdPage builder({
    String name = "/gasService/gasServiceIdClient",
    int index = -1,
    bool? popGesture,
  ...
  static GetPageBuilder getPageBuilder(String name, String keyMap) {
    Routes.getInstance.addRoute("GAS_CLIENT_ID_LIST", name);
    return () => GasClientIdView();
  }
}
