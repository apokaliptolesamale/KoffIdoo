...
import '../onat_historical_view.dart';

class OnatHistorical<T> extends CustomAppPageImpl<T> {
  @override
  ...
  static OnatHistorical builder({
    String name = "/OnatService/OnatHistorical",
    int index = -1,
    bool? popGesture,
  ...
  static GetPageBuilder getPageBuilder(String name, String keyMap) {
    Routes.getInstance.addRoute("ONAT_HISTORICAL", name);
    return () => OnatHistoricalView();
  }
}
