...
import '../client_id_add_frame_view.dart';

class GasClientIdAddPage<T> extends CustomAppPageImpl<T> {
  @override
  ...
  static GasClientIdAddPage builder({
    String name = "/gasService/gasServiceIdClient/gasServiceAddClientId",
    int index = -1,
    bool? popGesture,
  ...
  static GetPageBuilder getPageBuilder(String name, String keyMap) {
    Routes.getInstance.addRoute("GAS_CLIENT_ID_ADD", name);
