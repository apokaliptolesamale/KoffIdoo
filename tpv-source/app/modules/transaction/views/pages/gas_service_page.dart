...
import '../../bindings/clientinvoice_binding.dart';
import '../gas_service_view.dart';

class GasServicePageImpl<T> extends CustomAppPageImpl<T> {
  @override
  ...
  static GasServicePageImpl builder({
    String name = "/gasService",
    int index = -1,
    bool? popGesture,
  ...
  static GetPageBuilder getPageBuilder(String name, String keyMap) {
    Routes.getInstance.addRoute("GAS", name);
    return () => GasServiceView();
  }
}
