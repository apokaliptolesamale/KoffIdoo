...
import '../transfer_my_cards_view.dart';

class TransferMyCardPageImpl<T> extends CustomAppPageImpl<T> {
  @override
  ...
  static TransferMyCardPageImpl builder({
    String name = "/transfer/transferMyCardPage",
    int index = -1,
    bool? popGesture,
    ...
    bool showCupertinoParallax = true,
      ...
      TransferMyCardPageImpl(
        ...
        transitionDuration: transitionDuration,
        popGesture: popGesture,
        binding: binding ?? TransferBinding(),
        transition: transition,
        customTransition: customTransition,
        fullscreenDialog: fullscreenDialog,
        children: children,
  ...
  static GetPageBuilder getPageBuilder(String name, String keyMap) {
    Routes.getInstance.addRoute("TRANSFER_CARD_PAGE", name);
    return () => TransferMyCardView(
        // param: '',
        );
  }
}
