...
import '/app/modules/transaction/views/onat_payments_view.dart';

class OnatPaymentPageImpl<T> extends CustomAppPageImpl<T> {
  @override
  ...
  static OnatPaymentPageImpl builder({
    String name = "/onatPayments",
    String keyMap = "ONAT",
    int index = -1,
    bool? popGesture,
