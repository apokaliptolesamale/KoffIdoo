...
import '../onat_rc_05_view.dart';

class OnatRc05Page<T> extends CustomAppPageImpl<T> {
  @override
  ...
  static OnatRc05Page builder({
    String name = "/onatService/onatServiceRc05",
    int index = -1,
    bool? popGesture,
  ...
  static GetPageBuilder getPageBuilder(String name, String keyMap) {
    Routes.getInstance.addRoute("ONAT_RC_05", name);
    return () => OnatRc05View();
  }
}
