...
import '/app/modules/transaction/views/electricity_historical_view.dart';
import '/app/routes/app_pages.dart';


class ElectricityHistoricalPage<T> extends CustomAppPageImpl<T> {
  @override
  ...
  static ElectricityHistoricalPage builder({
    String name = "/electricityService/electricityHistorical",
    int index = -1,
    bool? popGesture,
    ...
    bool showCupertinoParallax = true,
      ...
      ElectricityHistoricalPage(
        ...
        transitionDuration: transitionDuration,
        popGesture: popGesture,
        binding: binding ?? InvoiceBinding(),
        transition: transition,
        customTransition: customTransition,
        fullscreenDialog: fullscreenDialog,
        children: children,
  ...
  static GetPageBuilder getPageBuilder(String name, String keyMap) {
    Routes.getInstance.addRoute("ELECTRICITY_HISTORICAL", name);
    return () => ElectricityHistoricalView();
  }
}
