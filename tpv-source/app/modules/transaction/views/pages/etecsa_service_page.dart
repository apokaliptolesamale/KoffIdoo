...
import '/app/modules/transaction/views/etecsa_service_view.dart';

class EtecsaService<T> extends CustomAppPageImpl<T> {
  @override
  ...
  static EtecsaService builder({
    String name = "/etecsaService",
    int index = -1,
    bool? popGesture,
  ...
  static GetPageBuilder getPageBuilder(String name, String keyMap) {
    Routes.getInstance.addRoute("ETECSA", name);
    return () => EtecsaServiceView();
  }
}
