...
import '../donationViews/donation_view.dart';

class DonationPageImpl<T> extends CustomAppPageImpl<T> {
  @override
  ...
  static DonationPageImpl builder({
    ...
    bool showCupertinoParallax = true,
      ...
      DonationPageImpl(
        ...
        transitionDuration: transitionDuration,
        popGesture: popGesture,
        binding: binding ?? DonationBinding(),
        transition: transition,
        customTransition: customTransition,
        fullscreenDialog: fullscreenDialog,
        children: children,
  ...
  static GetPageBuilder getPageBuilder(String name, String keyMap) {
    Routes.getInstance.addRoute("DONATION_VIEW", name);
    return () => DonationView();
  }
}
