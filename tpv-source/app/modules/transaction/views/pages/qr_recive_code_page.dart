...
import '../qr_recieve_code_view.dart';

class QrRecieveCodePageImpl<T> extends CustomAppPageImpl<T> {
  @override
  ...
  static QrRecieveCodePageImpl builder({
    String name = "/transfer/qrrecievecode",
    int index = -1,
    bool? popGesture,
  ...
  static GetPageBuilder getPageBuilder(String name, String keyMap) {
    Routes.getInstance.addRoute("FIND_ACCOUNT_PAGE", name);
    return () => QrRecieveCodeView();
  }
}
