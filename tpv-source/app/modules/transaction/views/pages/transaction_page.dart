...
import '/app/modules/transaction/views/transacciones_view.dart';
import '/app/routes/app_pages.dart';

class TransactionPageImpl<T> extends CustomAppPageImpl<T> {
  @override
  ...
  static TransactionPageImpl builder({
    ...
    bool showCupertinoParallax = true,
      ...
      TransactionPageImpl(
        ...
        transitionDuration: transitionDuration,
        popGesture: popGesture,
        binding: binding ?? TransactionBinding(),
        transition: transition,
        customTransition: customTransition,
        fullscreenDialog: fullscreenDialog,
        children: children,
  ...
  static GetPageBuilder getPageBuilder(String name, String keyMap) {
    Routes.getInstance.addRoute("TRANSACTIONS", name);
    // return() => Routes.getInstance.getByRoute("/transactions").page();
