...
import '../onat_service_view.dart';

class OnatServicePageImpl<T> extends CustomAppPageImpl<T> {
  @override
  ...
  static OnatServicePageImpl builder({
    String name = "/onatService",
    int index = -1,
    bool? popGesture,
  ...
  static GetPageBuilder getPageBuilder(String name, String keyMap) {
    Routes.getInstance.addRoute("ONAT", name);
    return () => OnatServiceView();
  }
}
