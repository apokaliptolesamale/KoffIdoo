...
import '/app/modules/transaction/views/Electricity_id_clients_view.dart';
import '/app/routes/app_pages.dart';

class ElectricityServiceAddClientIdPage<T> extends CustomAppPageImpl<T> {
  @override
  ...
  ElectricityServiceAddClientIdPage({
    required this.page,
    required this.name,
    this.keyMap = "/",
    this.index = -1,
  ...
  static ElectricityServiceAddClientIdPage builder({
    String name = "/electricityService/electricityAddClientId",
    int index = -1,
    bool? popGesture,
    ...
    bool showCupertinoParallax = true,
      ...
      ElectricityServiceAddClientIdPage(
        ...
        transitionDuration: transitionDuration,
        popGesture: popGesture,
        binding: binding ?? ClientInvoiceBinding(),
        transition: transition,
        customTransition: customTransition,
        fullscreenDialog: fullscreenDialog,
        children: children,
  ...
  static GetPageBuilder getPageBuilder(String name, String keyMap) {
    Routes.getInstance.addRoute("ELECTRICITY_CLIENT_ID", name);
    return () => ElectricityIdClientView();
  }
}
