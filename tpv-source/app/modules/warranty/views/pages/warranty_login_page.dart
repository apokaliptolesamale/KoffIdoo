...
class WarrantyLoginAppPageImpl<T> extends CustomAppPageImpl<T> {
  @override
  ...
  static WarrantyLoginAppPageImpl builder({
    String name = "/warranty/login",
    String keyMap = "WARRANTY_LOGIN",
    int index = -1,
    bool? popGesture,
  ...
  static GetPageBuilder getPageBuilder(String name, String keyMap) {
    ...
    return () => WarrantyLoginPage(
          child: WarrantyView(),
        );
  }
}

class WarrantyLoginPage extends GetResponsiveView<WarrantyController> {
  final Widget? child;
