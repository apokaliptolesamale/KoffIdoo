...
import '../../../../../app/modules/warranty/views/warranty_view.dart';
import '../../../../routes/app_routes.dart';

class WarrantyIndexAppPageImpl<T> extends CustomAppPageImpl<T> {
  @override
  ...
  static WarrantyIndexAppPageImpl builder({
    String name = "/warranty/index",
    String keyMap = "WARRANTY_INDEX",
    int index = -1,
    bool? popGesture,
  ...
  static GetPageBuilder getPageBuilder(String name, String keyMap) {
    ...
    return () => WarrantyIndexPage(
          child: WarrantyView(),
        );
  }
}

class WarrantyIndexPage extends GetResponsiveView<WarrantyController> {
  final Widget? child;
