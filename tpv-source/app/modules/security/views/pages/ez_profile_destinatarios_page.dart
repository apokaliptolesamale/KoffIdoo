...
class EzProfileDestinatarioPageImpl<T> extends CustomAppPageImpl<T> {
  @override
  ...
  static EzProfileDestinatarioPageImpl builder({
    String name = "/security/ezprofileview/ezprofiledestinatario",
    String keyMap = "SECURITY_EZPROFILE_DESTINATARIO",
    int index = -1,
    bool? popGesture,
  ...
  static GetPageBuilder getPageBuilder(String name, String keyMap) {
    ...
    return () => EzProfileDestinatarioView();
  }
}
