...
class ResetPaymentPasswordPageImpl<T> extends CustomAppPageImpl<T> {
  @override
  ...
  static ResetPaymentPasswordPageImpl builder({
    String name = "/security/ezprofileview/ezprofileresetpaymentpassword",
    String keyMap = "EZ_PROFILE_RESET_PAYMENT_PASSWORD",
    int index = -1,
    bool? popGesture,
  ...
  static GetPageBuilder getPageBuilder(String name, String keyMap) {
    ...
    return () => ResetPaymentPasswordView();
  }
}
