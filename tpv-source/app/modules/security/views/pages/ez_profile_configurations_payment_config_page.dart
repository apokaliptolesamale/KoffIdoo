...
import '../ez_profile_configurations_payment_config_view.dart';

class EzProfilePaymentConfigPageImpl<T> extends CustomAppPageImpl<T> {
  @override
  ...
  EzProfilePaymentConfigPageImpl({
    required this.name,
  ...
  static EzProfilePaymentConfigPageImpl builder({
    String name =
  ...
  static GetPageBuilder getPageBuilder(String name, String keyMap) {
    ...
    return () => EzProfilePaymentConfigView();
  }
}
