...
import '../ez_security_profile_view.dart';

class EzSecurityProfilePageImpl<T> extends CustomAppPageImpl<T> {
  @override
  ...
  static EzSecurityProfilePageImpl builder({
    String name = "/security/ezprofileview/ezprofileconfig/securityProfileview",
    String keyMap = "EZ_SECURITY_PROFILE_PAGE",
    int index = -1,
    bool? popGesture,
