...
import '/app/modules/security/bindings/account_binding.dart';
...
import '../ez_profile_view.dart';

class EzProfilePageImpl<T> extends CustomAppPageImpl<T> {
  @override
  ...
  static EzProfilePageImpl builder({
    String name = "/security/ezprofile",
    String keyMap = "SECURITY_EZPROFILE",
    int index = -1,
    bool? popGesture,
