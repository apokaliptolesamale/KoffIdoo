...
class SecurityApkCallBackPageImpl<T> extends CustomAppPageImpl<T> {
  @override
  ...
  static SecurityApkCallBackPageImpl builder({
    String name = "/apk-callback",
    String keyMap = "APK_CALLBACK",
    int index = -1,
    bool? popGesture,
