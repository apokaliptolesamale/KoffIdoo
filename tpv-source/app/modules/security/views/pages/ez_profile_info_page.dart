...
import '../ez_profile_info_view.dart';

class EzProfileInfoPageImpl<T> extends CustomAppPageImpl<T> {
  @override
  ...
  static EzProfileInfoPageImpl builder({
    String name = "/security/ezprofileview/ezprofileinfo",
    String keyMap = "SECURITY_EZPROFILE_INFO",
    int index = -1,
    bool? popGesture,
