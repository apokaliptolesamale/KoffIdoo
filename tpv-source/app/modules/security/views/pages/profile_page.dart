...
import '../../../../../app/modules/security/views/profile_view.dart';
import '../../../../routes/app_routes.dart';

class ProfilePageImpl<T> extends CustomAppPageImpl<T> {
  @override
  ...
  static ProfilePageImpl builder({
    String name = "/security/profile",
    String keyMap = "SECURITY_PROFILE",
    int index = -1,
    bool? popGesture,
