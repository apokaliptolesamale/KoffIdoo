...
// import '../ez_reset_payment_password_view.dart';

// class EzResetPaymentPasswordPageImpl<T> extends CustomAppPageImpl<T> {
//   @override
...
//   EzResetPaymentPasswordPageImpl({
//     required this.name,
//     required this.page,
//     this.index = -1,
//     this.title,
...
//   static EzResetPaymentPasswordPageImpl builder({
//     String name =
//         "/security/ezprofileview/ezprofileconfig/ezprofilepaymentconfig/ezresetpaymentpassword",
//     int index = -1,
//     bool? popGesture,
...
//     Routes.getInstance.addRoute("EZ_RESET_PAYMENT_PASSWORD", name);
