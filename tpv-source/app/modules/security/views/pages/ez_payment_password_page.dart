...
class EzPaymentPasswordPageImpl<T> extends CustomAppPageImpl<T> {
  @override
  ...
  static EzPaymentPasswordPageImpl builder({
    String name = "/security/ezprofileview/ezprofilepaymentpasswordview",
    String keyMap = "EZPROFILE_PAYMENT_PASSWORD_VIEW",
    int index = -1,
    bool? popGesture,
