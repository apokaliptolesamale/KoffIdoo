...
import '../../../../../app/modules/home/views/user_notifications_view.dart';
import '../../../../../app/modules/security/bindings/security_binding.dart';
import '../../../../routes/app_routes.dart';

class UserNotificationsPageImpl<T> extends CustomAppPageImpl<T> {
  @override
  ...
  static UserNotificationsPageImpl builder({
    String name = "/security/user-notifications",
    String keyMap = "SECURITY_USER_NOTIFICATIONS",
    int index = -1,
    bool? popGesture,
