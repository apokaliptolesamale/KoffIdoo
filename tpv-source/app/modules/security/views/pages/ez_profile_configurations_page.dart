...
import '../ez_profile_configurations_view.dart';

class EzProfileConfigPageImpl<T> extends CustomAppPageImpl<T> {
  @override
  ...
  static EzProfileConfigPageImpl builder({
    String name = "/security/ezprofileview/ezprofileconfig",
    String keyMap = "SECURITY_EZPROFILE_CONFIG",
    int index = -1,
    bool? popGesture,
