...
class CardAppPageImpl<T> extends CustomAppPageImpl<T> {
  @override
  ...
  static CardAppPageImpl builder({
    String name = "/card",
    String keyMap = "CARD",
    int index = -1,
    bool? popGesture,
...
/* class EzHomePage extends GetResponsiveView<CardController> {
  final Widget child;
