...
class IdpProvider extends GetProviderImpl {
  @override
  Future<Either<Exception, TModel>> addEntity<TModel>(TModel entity) async {
    log("Adicionando nueva entidad de tipo:IdpModel.");
    Map<String, dynamic> data = {};
    if (entity is IdpModel) {
      data = entity.toJson();
  ...
  Future<Either<Exception, TModel>> getEntity<TModel>(dynamic id) async {
    log("Cargando entidad de tipo 'Idp' con identificador=$id");
    String url = '';
    Map<String, String> headers = await HeaderRequestImpl(
      headers: {
        "Accept": "application/json",
  ...
  @override
  IdpProvider setBaseUrl(String newBaseUrl) {
