// ignore_for_file: library_private_types_in_public_api, overridden_fields, must_be_immutable

import 'package:flutter/material.dart';
import 'package:get/get.dart';

import '/app/modules/warranty/views/pages/transport_info_page.dart';
...
class OrderHomePage extends StatefulWidget {
  @override
  OrderHomePageState createState() => OrderHomePageState();
}

class OrderHomePageImpl<T> extends CustomAppPageImpl<T> {
  @override
  ...
  static OrderHomePageImpl builder({
    String name = "/order/orders",
    String keyMap = "ORDERS",
    int index = -1,
    bool? popGesture,
...
class OrderHomePageState extends State<OrderHomePage> {
  int index = 0;

  @override
  Widget build(BuildContext context) {
    return TransportOrdersInfoPage();
  }
