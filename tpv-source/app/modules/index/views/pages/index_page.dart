...
import '../../../../../app/modules/index/widgets/index_nav_bar.dart';
import '../../../../../app/routes/app_pages.dart';
import '../../controllers/index_controller.dart';

class IndexAppPageImpl<T> extends CustomAppPageImpl<T> {
  @override
  ...
  static IndexAppPageImpl builder({
    String name = "/index",
    String keyMap = "INDEX",
    int index = -1,
    bool? popGesture,
...
class IndexPage extends GetResponsiveView<IndexController> {
  final Widget child;
