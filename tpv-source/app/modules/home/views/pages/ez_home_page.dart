...
import '../ez_home_view.dart';

class EzHomeAppPageImpl<T> extends CustomAppPageImpl<T> {
  @override
  ...
  static EzHomeAppPageImpl builder({
    String name = "/ezhome",
    String keyMap = "ezhome",
    int index = -1,
    bool? popGesture,
...
class EzHomePage extends GetResponsiveView<EzHomeController> {
  final Widget child;

  EzHomePage({Key? key, required this.child})
      : super(
            key: key,
