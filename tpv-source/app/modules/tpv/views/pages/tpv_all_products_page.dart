...
import '/app/modules/tpv/views/tpv_all_products_view.dart';
import '../../../../routes/app_routes.dart';

class TpvAllProductsPage extends GetResponsiveView<TpvController> {
  final Widget? child;
  ...
  Widget build(BuildContext context) {
    return child ?? TpvAllProductsView();
  }
}

class TpvAllProductsPageImpl<T> extends CustomAppPageImpl<T> {
  @override
  ...
  static TpvAllProductsPageImpl builder({
    String name = "/tpv-all-products",
    String keyMap = "TPV_ALL_PRODUCTS",
    int index = -1,
    bool? popGesture,
  ...
  static GetPageBuilder getPageBuilder(String name, String keyMap) {
    ...
    return () => TpvAllProductsPage(
          child: TpvAllProductsView(),
        );
  }
}
