...
import '../tpv_settings_view.dart';

class TpvSettingsPage extends GetResponsiveView<TpvController> {
  final Widget child;

  TpvSettingsPage({Key? key, required this.child})
      : super(
            key: key,
...
class TpvSettingsPageImpl<T> extends CustomAppPageImpl<T> {
  @override
  ...
  static TpvSettingsPageImpl builder({
    String name = "/tpv-settings-page",
    String keyMap = "TPV_SETTINGS_PAGE",
    int index = -1,
    bool? popGesture,
