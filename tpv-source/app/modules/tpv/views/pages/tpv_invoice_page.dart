...
import '../tpv_invoice_view.dart';

class TpvInvoicePage extends GetResponsiveView<TpvController> {
  final Widget? child;
  ...
  Widget build(BuildContext context) {
    return child ?? TpvInvoiceView();
  }
}

class TpvInvoicePageImpl<T> extends CustomAppPageImpl<T> {
  @override
  ...
  static TpvInvoicePageImpl builder({
    String name = "/tpv-invoice",
    String keyMap = "TPV_INVOICE",
    int index = -1,
    bool? popGesture,
  ...
  static GetPageBuilder getPageBuilder(String name, String keyMap) {
    ...
    return () => TpvInvoicePage(
          child: TpvInvoiceView(),
        );
  }
}
