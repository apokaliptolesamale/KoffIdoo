...
class TpvSalesHistoryPage extends GetResponsiveView<TpvController> {
  final Widget? child;
  ...
  Widget build(BuildContext context) {
    return child ?? SalesHistoryView();
  }
}

class TpvSalesHistoryPageImpl<T> extends CustomAppPageImpl<T> {
  @override
  ...
  static TpvSalesHistoryPageImpl builder({
    String name = "/tpv-sales-history",
    String keyMap = "TPV_SALES_HISTORY",
    int index = -1,
    bool? popGesture,
