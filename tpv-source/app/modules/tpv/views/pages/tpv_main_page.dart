...
class TpvMainPage extends GetResponsiveView<TpvController> {
  final Widget? child;
...
class TpvMainPageImpl<T> extends CustomAppPageImpl<T> {
  @override
  ...
  static TpvMainPageImpl builder({
    String name = "/tpv-main",
    String keyMap = "TPV_MAIN",
    int index = -1,
    bool? popGesture,
