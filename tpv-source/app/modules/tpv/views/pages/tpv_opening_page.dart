...
import '../tpv_opening_view.dart';

class TpvOpeningPage extends GetResponsiveView<TpvController> {
  final Widget? child;
  ...
  Widget build(BuildContext context) {
    return child ?? TpvOpeningView();
  }
}

class TpvOpeningPageImpl<T> extends CustomAppPageImpl<T> {
  @override
  ...
  static TpvOpeningPageImpl builder({
    String name = "/tpv-opening",
  ...
  static GetPageBuilder getPageBuilder(String name, String keyMap) {
    ...
    return () => TpvOpeningPage(
          child: TpvOpeningView(),
        );
  }
}
