...
import '/app/modules/tpv/views/first_time_config_view.dart.dart';
import '../../../../routes/app_routes.dart';

class FirstTimeConfigPage extends GetResponsiveView<TpvController> {
  final Widget child;

  FirstTimeConfigPage({Key? key, required this.child})
      : super(
            key: key,
...
class FirstTimeConfigPageImpl<T> extends CustomAppPageImpl<T> {
  @override
  ...
  static FirstTimeConfigPageImpl builder({
    String name = "/tpv-first-time-config-page",
    String keyMap = "TPV_FIRST_TIME_CONFIG_PAGE",
    int index = -1,
    bool? popGesture,
