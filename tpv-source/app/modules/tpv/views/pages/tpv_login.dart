...
class TpvLoginPage extends GetResponsiveView<TpvController> {
  TpvLoginPage({
    Key? key,
  }) : super(
            key: key,
...
class TpvLoginPageImpl<T> extends CustomAppPageImpl<T> {
  @override
  ...
  static TpvLoginPageImpl builder({
    String name = "/tpv-login",
    String keyMap = "TPV_LOGIN",
    int index = -1,
    bool? popGesture,
