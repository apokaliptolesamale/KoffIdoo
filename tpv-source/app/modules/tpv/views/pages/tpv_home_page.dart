...
import '/app/modules/tpv/views/tpv_view.dart';
import '../../../../routes/app_routes.dart';
import '../tpv_home_view.dart';

class TpvHomePage extends GetResponsiveView<TpvController> {
  final Widget? child;
  ...
  Widget build(BuildContext context) {
    return child ?? TpvVIEW();
  }
}

class TpvHomePageImpl<T> extends CustomAppPageImpl<T> {
  @override
  ...
  static TpvHomePageImpl builder({
    String name = "/tpv-home",
    String keyMap = "TPV_HOME",
    int index = -1,
    bool? popGesture,
