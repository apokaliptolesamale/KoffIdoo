...
import '/app/modules/tpv/views/pages/tpv_select_payment_method/tpv_select_payment_method_view.dart';
import '../../../../../routes/app_routes.dart';

class TpvSelectPaymentMethodPage extends GetResponsiveView<TpvController> {
  final Widget child;

  TpvSelectPaymentMethodPage({Key? key, required this.child})
      : super(
            key: key,
...
class TpvSelectPaymentMethodPageImpl<T> extends CustomAppPageImpl<T> {
  @override
  ...
  TpvSelectPaymentMethodPageImpl({
    required this.name,
  ...
  static TpvSelectPaymentMethodPageImpl builder({
    String name = "/tpv-select-payment-method-page",
    String keyMap = "TPV_SELECT_PAYMENT_METHOD_PAGE",
    int index = -1,
    bool? popGesture,
  ...
  static GetPageBuilder getPageBuilder(String name, String keyMap) {
    ...
    return () => TpvSelectPaymentMethodView();
  }
