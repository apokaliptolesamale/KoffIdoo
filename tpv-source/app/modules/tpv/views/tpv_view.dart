...
import '../views/tpv_mobile_body_view.dart';
import '../views/tpv_tablet_body_view.dart';
...
class TpvVIEW extends GetResponsiveView<TpvController> {
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(builder: (context, constraints) {
      if (constraints.maxWidth < 600) {
        return TpvMobileBodyView();
      } else {
        return TpvTabletBodyView();
      }
    });
  }
}
