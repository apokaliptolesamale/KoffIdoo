...
class TpvTabletBodyView extends GetResponsiveView<TpvController> {
  TpvTabletBodyView({
    Key? key,
  }) : super(
            key: key,
...
class _CustomOrientationBuilderState extends State<CustomOrientationBuilder> {
            ...
            child: FutureBuilder(
              ...
              builder: (context,
                ...
                if (!snapshot.hasData) {
                  ...
                  return landscapeRight(context, list);
                }
              },
            ),
          )
                    ...
                    child: Container(
                      ...
                      child: Row(
                        ...
                        children: [
                                ...
                                builder: (context) {
                                  ...
                                  return AlertDialog(
                                    ...
                                    content: TextField(
                                      ...
                                      onChanged: (value) {
                                        newQuantity =
                                            int.tryParse(value) ?? newQuantity;
                                      },
                                    ),
                                    actions: <Widget>[
                                      TextButton(
                          ...
                          Text(
                            truncateString(listOfSelectedProducts[index].name),
                          ),
                          Row(
                            children: [
  ...
  Widget landscapeRight(BuildContext context, List<ProductModel> list) {
    log(list.length);
    return Container(
      height: double.infinity,
      width: double.infinity,
