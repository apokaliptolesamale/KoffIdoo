...
import '../../modules/home/views/pages/ez_home_page.dart';
import '../../modules/security/controllers/security_controller.dart';
import '../../modules/splash/splash_page.dart';
import '../../routes/app_pages.dart';
import '../images/background_image.dart';

class EnzonaApp extends StatelessWidget
    with
        WidgetsBindingObserver,
        SubscriberMixinImpl<EnzonaApp>,
        PublisherMixinImpl<EnzonaApp>
  ...
  @override
  Map<String, List<void Function(Publisher<Subscriber<EnzonaApp>> event)>>
  ...
  Widget build(BuildContext context) {
    ...
    final theme = ThemeData.light(); //ctl.getActiveTheme();
        ...
        return GetBuilder<SecurityController>(
          ...
          builder: ((controller) {
            ...
            if (controller.authStatus == AuthStatus.cheking) {
              log('Main de enzona: chequing auth status');
              return SplashPage(
                isNetWorkAvaliable: isConected,
                onReload: () {
                  runApp(EnzonaApp());
              ...
              log('Main de enzona: usuario autenticado');
              return EzHomePage(
                child: child!,
              );
            } else {
              log('Main de enzona: usuario no autenticado');
              return child!;
            }
          }),
        );
