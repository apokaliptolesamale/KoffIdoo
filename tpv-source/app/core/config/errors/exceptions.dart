...
class ClientException implements CustomException {
  @override
  dynamic response;
  @override
  Fault? fault;
...
class EmptyResposeException extends HttpServerException {
  @override
  dynamic response;
  @override
  String message = "No existen datos para mostrar.";
  @override
  Fault? fault = Fault(
      faultCode: 0,
      type: "TypeError",
      ...
      description:
          "No existen datos para mostrar, los parámetros de filtro proporcionados proporciona una salida vacía.");

  EmptyResposeException({
    this.response,
    this.fault,
  }) : super(
          response: response,
