...
import '/remote/basic_utils/src/CryptoUtils.dart';
import '/remote/basic_utils/src/IterableUtils.dart';
import '/remote/basic_utils/src/StringUtils.dart';
import '/remote/basic_utils/src/model/crl/CertificateListData.dart';
import '/remote/basic_utils/src/model/crl/CertificateRevokeListData.dart';
import '/remote/basic_utils/src/model/crl/CrlEntryExtensionsData.dart';
import '/remote/basic_utils/src/model/crl/CrlReason.dart';
import '/remote/basic_utils/src/model/crl/RevokedCertificate.dart';
import '/remote/basic_utils/src/model/csr/CertificateSigningRequestData.dart';
import '/remote/basic_utils/src/model/csr/CertificateSigningRequestExtensions.dart';
import '/remote/basic_utils/src/model/csr/CertificationRequestInfo.dart';
import '/remote/basic_utils/src/model/csr/SubjectPublicKeyInfo.dart';
import '/remote/basic_utils/src/model/ocsp/BasicOCSPResponse.dart';
import '/remote/basic_utils/src/model/ocsp/OCSPCertStatus.dart';
import '/remote/basic_utils/src/model/ocsp/OCSPCertStatusValues.dart';
import '/remote/basic_utils/src/model/ocsp/OCSPResponse.dart';
import '/remote/basic_utils/src/model/ocsp/OCSPResponseData.dart';
import '/remote/basic_utils/src/model/ocsp/OCSPResponseStatus.dart';
import '/remote/basic_utils/src/model/ocsp/OCSPSingleResponse.dart';
import '/remote/basic_utils/src/model/pkcs7/Pkcs7CertificateData.dart';
import '/remote/basic_utils/src/model/x509/CertificateChainCheckData.dart';
import '/remote/basic_utils/src/model/x509/CertificateChainPairCheckResult.dart';
import '/remote/basic_utils/src/model/x509/ExtendedKeyUsage.dart';
import '/remote/basic_utils/src/model/x509/TbsCertificate.dart';
import '/remote/basic_utils/src/model/x509/VmcData.dart';
import '/remote/basic_utils/src/model/x509/X509CertificateData.dart';
import '/remote/basic_utils/src/model/x509/X509CertificateDataExtensions.dart';
import '/remote/basic_utils/src/model/x509/X509CertificatePublicKeyData.dart';
import '/remote/basic_utils/src/model/x509/X509CertificateValidity.dart';
...
class X509Utils {
  ...
  static ASN1Sequence buildOCSPRequest(String pem, {String? intermediate}) {
    late ASN1Sequence x509Sequence;
    late X509CertificateData x509;
    late ASN1Sequence x509SequenceIssuer;
  ...
  static String fixPem(String pem) {
    ...
    for (var element in tmp.codeUnits) {
