...
// import '../providers/tpv_provider.dart';

// /// Implementación de la interfaz de fuente de datos local: LocalDataSource
// class LocalTpvDataSourceImpl implements LocalDataSource {
//   final http.Client client = Get.find();

//   LocalTpvDataSourceImpl();

//   @override
//   TpvProvider get getProvider => Get.find();
...
//   TpvModel getModelFromJson(String data) {
//     return tpvModelFromJson(data);
//   }
...
//   Future<TpvList> requestTpvs(String url) async {
//     final content = readFileAsync(url);
//     return Future.value(tpvListModelFromJson(content));
//   }
...
//   readFileAsync(String path) async {
...
// class RemoteTpvDataSourceImpl implements RemoteDataSource {
//   final http.Client client = Get.find();
